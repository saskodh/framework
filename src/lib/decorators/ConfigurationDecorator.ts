...
export function Configuration() {
    return function (target) {
        if (target[CONFIGURATION_HOLDER_TOKEN]) throw new Error('Duplicate @Configuration decorator');
...
export class ConfigurationUtil {
    ...
    static getConfigurationData (target): ConfigurationData {
        if (!target[CONFIGURATION_HOLDER_TOKEN]) throw new Error('Given target is not a @Configuration class');
